...
const FLIGHTS: FlightOption[] = [
  {
    ...
    recommended: true,
    reasoning:
      'Gets you to Mumbai at 08:10 — nearly 6 hours before your 14:00 meeting. Non-stop, lowest carbon, best value.',
  },
  {
    id: 'f2',
    airline: 'Air India',
...
const RETURN_FLIGHTS: FlightOption[] = [
  {
    ...
    recommended: true,
    reasoning:
      'Departs 3 hours after your meeting ends — comfortable buffer for any overruns or a quick dinner. Arrives Kochi by 21:00.',
  },
  {
    id: 'r2',
    airline: 'Air India',
...
const LEH_FLIGHTS: FlightOption[] = [
  {
    ...
    carbonKg: 145,
    recommended: true,
    reasoning: 'Best connection via Delhi. Departs early from Kochi, arrives Leh at 12:30 — giving you the afternoon to acclimatise before any activity.',
  },
  {
    id: 'lf2',
    airline: 'Air India',
